    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 p-4 md:p-8">
      ...
      {!loading && !error && (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          {/* Row 1: Factor Scores (4 Columns) */}
          <DashboardCard 
            title="Trend Following" 
            description="Smoothed Mean/Range Signal. High = Uptrend."
            className="col-span-1 h-[400px]"
          >
            {factorData && <FactorBarChart data={factorData.trendFollowing} />}
          </DashboardCard>
          ...
          {/* Row 2: Breadth Metrics (2 Columns - Spanning full width on large) */}
          <div className="col-span-1 md:col-span-2 xl:col-span-4 grid grid-cols-1 md:grid-cols-2 gap-6">
            <DashboardCard 
              title="Breadth: % > SMA" 
              description="% of assets above their Simple Moving Average."
              className="h-[350px]"
            >
              {breadthData && <BreadthChart data={breadthData.aboveSma} type="SMA" />}
            </DashboardCard>

            <DashboardCard 
              title="Breadth: Range High-Low" 
              description="Avg position within x-day High/Low Range."
              className="h-[350px]"
            >
              {breadthData && <BreadthChart data={breadthData.rangePosition} type="RHL" />}
            </DashboardCard>
          </div>


          {/* Row 3: Funding Rates & Volume */}
          <DashboardCard 
          ...
          <DashboardCard 
            ...
            className="col-span-1 md:col-span-2 xl:col-span-4 min-h-[250px]"
          >
          ...
          <DashboardCard 
            ...
            className="col-span-1 md:col-span-2 xl:col-span-4 h-[400px]"
          >
          ...
          <DashboardCard 
            ...
            className="col-span-1 md:col-span-2 xl:col-span-4 h-[600px]"
          >
      ...
      {loading && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex flex-col items-center justify-center">
          ...
          <p className="text-slate-500 text-sm mt-2">Analyzing 500+ days of history for 50 assets.</p>
        </div>
      )}
    </div>
  );
